...
with st.sidebar:
    ...
    st.session_state['pred'] = st.button(label='Predict', on_click = get_prediction, args=(txt, ))
...
# prediction output
if st.session_state['pred'] == 'The tweet is Disaster Tweet':
    with col1:
        st.markdown('<p class="big-font"> Tweet refers to real disaster &#9888;&#65039; </p>', unsafe_allow_html=True)

elif st.session_state['pred'] == 'The tweet is Non Disaster Tweet':
    with col1:
